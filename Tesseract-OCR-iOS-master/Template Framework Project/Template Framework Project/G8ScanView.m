...
-(void)addScaningWindow {
    ...
    _IDCardScanningWindowLayer.bounds = (CGRect){CGPointZero, {width, width * 0.124}};
    [self layoutIfNeeded];
    
    self.targetView = [UIView new];
    self.targetView.bounds = _IDCardScanningWindowLayer.bounds;
    self.targetView.frame = _IDCardScanningWindowLayer.frame;
    _IDCardScanningWindowLayer.cornerRadius = 3;
